...
\textbf{\ttlfnt \TITLE}}
\author{
\aufnt{Paper \#00, \pageref{LastPage} Pages}
%\aufnt{Sarthak Grover\pu, xxx\aff2, yyy\aff3}\\
...
\flushleft\balance\bibliography{paper}
% sigproc.bib is the name of the
