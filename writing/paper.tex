...
\newcommand{\AUTHORS}{Sarthak Grover, Roya Ensafi, Nick Feamster}
% Title needs work
\newcommand{\TITLE}{When the Rich get Richer: A Case Study of High Speed Tier 
Usage Behavior}
%Interpreting Usage Patterns to Improve Broadband Deployment
...
%
\newcommand{\red}[1]{\textcolor{red}{#1}}		% things to redo
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\re}[1]{\note{green}{Roya: #1}}		% Roya comments
\newcommand{\sg}[1]{\note{red}{SG: #1}}			% Sarthak comments
\newcommand{\todo}[1]{\note{blue}{TODO: #1}}	% use for todo
\newcommand{\nick}[1]{\note{magenta}{Nick: #1}}	% use for todo
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\date{Paper \#0, \pageref{LastPage} Pages}
%\date{}
\title{\textbf{\ttlfnt \TITLE}}
\author{
  %\aufnt{Paper \#0, \pageref{LastPage} Pages}
  \aufnt{Sarthak Grover, Roya Ensafi, Nick Feamster}\\
...
%C.2.1 [Computer-Communication Networks] {\em Category}
