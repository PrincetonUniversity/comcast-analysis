...
%By declaring fixed broadband a regulated commodity, it is
%necessary that in the future, broadband pricing policy take into account usage characteristics.

%: (a) define benchmarks based on standards other
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% LIST OF CONTRIBUTIONS BASED ON THE RESULTS
% TODO currently does not flow well from the previous paragraph
\input{contributions}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
