...
ISP's service tier.} To do so, we use a \green{randomized control trial to compare
...
\red{subscribers with more moderate traffic demands increased their traffic
...
fact that \red{the most significant increases that we observed as a result of
