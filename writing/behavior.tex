...
%
\end{minipage}
\caption{95th percentile traffic demand (bytes per 15 minutes) per subscriber for \control{} and \treatment{}\label{fig:traffic-demand-overall}}
\end{figure}
...
higher. This happens in 70\% of the instances.  On taking the ratio of
the difference in demand, with the equivalent demand of the lower tiers,
we find that for 40\% of subscribers with low peak demands in the
control group, there are 40\% subscribers in the treatment group with
...
most subscribers reach within 95\% of daily maximum demand between 8:00 p.m.--12:00 a.m.
