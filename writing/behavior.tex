...
\includegraphics[width=\linewidth]{figures/diff_perc95_bytes_subsc-overall_01.pdf}		% 1 percentile
               \caption{Difference in overall peak per
                 subscriber. y-axis values are bytes transferred in the
                 peak 15-minute interval. \label{fig:diff-peak-overall}}
\end{subfigure}
%
\end{minipage}
...
disparity appears as a large gap under the 50\% mark in
...
\f{One possible explanation for such behavior is that users see better
performance (\eg, faster downloads) on the higher service tier, and thus
increase their usage, even if they do not ever use the full network capacity.}
...
400~MB. For these subscribers in \treatment{}, the equivalent
subscribers in \control{} had demands upto 10~MB higher. 20\% of the
...
highest demanding subscribers in \treatment{} uploaded between 2--10~MB
more than the top 10\% of \control{}.
\fi
...
\end{minipage}
  ...
  group. y-axis values are bytes transferred in the peak 15-minute interval.
  \label{fig:traffic-demand-daily}}
\end{figure}


\f{Further investigation revealed that this phenomenon is also present
daily, not only in aggregate.}  Figure~\ref{fig:traffic-demand-daily}
shows that when subscribers on the lower tier had a daily peak demand
under 600 MB, subscribers in the higher tier had demands 5--20~MB
higher. This happens in 70\% of the instances.  The ratio of the
the differences in demand across percentiles also yields that
the 40\% of subscribers with lowest peak demands in the
control group increase their daily peak demand more than double their traffic demand in response to
