\begin{abstract}
  ...
  In a unique natural experiment involving thousands of Comcast
  ...
  increase the 95th percentile of their daily peak usage by 10\% when
  their service plan is upgraded.  Additionally, we find that, for these
  users, median off-peak traffic load increases by about 20\%.
\end{abstract}
