...
\includegraphics[width=0.55\linewidth]{figures/boxplot_monthly_avg_demand_downlink.pdf}
  \caption{\red{Distribution of average demand for across subscribers in the \control{} and 
\treatment{} groups from October through December 2014.}\label{fig:traffic-load}}
\end{figure}
\subsection{Data}
...
more than 80\% during their lifetime. \red{\textrm{Our ultimate dataset consists of
...
during non-prime-time. We normalize traffic to 1,000 subscribers for comparison.} The daily demand is the average traffic demand per 
