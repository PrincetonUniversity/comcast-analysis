...
\hline
\multicolumn{1}{| c |}{} & \multicolumn{4}{ c |}{Hourly traffic per 1,000 subscribers} & \multicolumn{1}{ c |}{per subscriber}\\ 
Dataset 		& Total GBytes & 95\% Traffic & \textbf{PT} & \textbf{Non-PT}		& Daily Demand \\ \hline
control DW		& \num{2.67e+5} & 234.5  & \textbf{205.1}  & \textbf{108.5}		& 2.97 \\
treatment DW	& \num{2.95e+5} & 244.42  & \textbf{209.5}  & \textbf{122.3}   	& 3.30 \\\specialrule{0.005em}{0em}{0em} 
control UP 	& \num{2.98e+4} & 21.39  & \textbf{18.942}  & \textbf{12.80}  	& 0.33 \\
treatment UP 	& \num{4.27e+4} & 31.48   & \textbf{22.81}   & \textbf{19.02} 	& 0.48 \\\hline                                
\end{tabular}
\caption{Overview of the \control{} (4,895 subscribers) and \treatment{} 
