...
\begin{figure}[t]
\centering
\includegraphics[width=0.49\linewidth]{figures/boxplot_monthly_avg_demand_downlink.pdf}
  \caption{\red{Traffic demand of an average subscriber in the \control{} and 
\treatment{} groups from Oct -- Dec, 2014.}\label{fig:traffic-load}}
\end{figure}
\subsection{Data}
...
Figure \ref{fig:traffic-load} \sgfoot{improve captions?}
